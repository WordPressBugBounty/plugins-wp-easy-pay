...
wp_localize_script(
	...
	array(
		...
		'afterpay'                        => isset($afterpay_available) && $afterpay_available == true ? $afterpay : '',
		'cashapp'                         => isset($cashapp_available) && $cashapp_available == true ? $cashapp : '',
		'ach_debit'                       => isset($ach_debit_available) && $ach_debit_available == true ? $ach_debit : '',
