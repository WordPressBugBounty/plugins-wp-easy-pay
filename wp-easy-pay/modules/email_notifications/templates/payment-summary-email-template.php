		...
		<div class="upgrade_premium_container">
			...
			<div class="upgrade_premium_list">
				...
				<div class="upgrade_premium_button" style="text-align:center;margin-top: 20px;">
					<a href="https://wpeasypay.com/pricing/?utm_source=plugin&amp;utm_medium=payment_summary_email" target="_blank" rel="noopener noreferrer">
						<button type="button" class="upgrade_button" style="padding:8px 10px; font-family: 'circular'; border: 1px solid #FF8F00;background: #FFA41C;border-radius: 5px;"><span class="fa-solid--crown">
